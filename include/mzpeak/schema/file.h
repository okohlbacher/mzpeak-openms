 ...
 * place the unit is stated — which matters for retention time, where mistaking
 * minutes for seconds is a 60x error.
 */
struct ColumnMapping {
  ...
  /// Equality operator (File's defaulted operator== needs it).
